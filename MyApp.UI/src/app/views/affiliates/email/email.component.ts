...
import { DataTableItems, DataTableItemsType } from './emaildata'
...
export class EmailComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] = ["ID", "Host", "Email", "Email_MD5", "Affiliate_ID", "UTM_Source", "UTM_Campaign", "UTN_Term", "IP", "User_Agent", "Status", "Hits"]
