...
import { DataTableItems, DataTableItemsType } from '../frauds/fraudsdata'
...
@Component({
  ...
  styleUrl: './frauds.component.scss'
})

export class FraudsComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] = ["ID", "Affiliate_ID", "Sub_ID", "Leads", "Fraud_Ratio", "Paste_Ratio", "Completed_Ratio", "First_Detected", "status"]
