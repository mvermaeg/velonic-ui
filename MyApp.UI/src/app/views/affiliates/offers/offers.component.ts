...
import { DataTableItems, DataTableItemsType } from './offersdata'
...
export class OffersComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] =["Name", "Display_Name", "EXclusive", "Campagin_Name", "Page_Name", "Next_Page_Name", "created", "updated", "status"]
