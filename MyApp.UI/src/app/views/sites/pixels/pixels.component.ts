...
import { DataTableItems, DataTableItemsType } from './pixelsdata'
...
export class PixelsComponent implements OnInit {
   selectedFields: (keyof DataTableItemsType)[] = ["Name","Campaign_Name","Source_Name","Placement","Type","Pixel_ID","Pixel_Snippet","Status"]
