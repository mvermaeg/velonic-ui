...
import { DataTableItems, DataTableItemsType } from './domainsdata'
...
export class DomainsComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] = ["Domain_Name", "Site_Name", "Main", "SSL", "Created", "Updated", "Status"]
