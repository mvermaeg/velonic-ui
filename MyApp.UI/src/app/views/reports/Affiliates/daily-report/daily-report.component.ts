...
import { DataTableItems, DataTableItemsType } from './dailyreportdata'
import { TableService } from '@/app/tables/table.service'
@Component({
  selector: 'app-report-affiliates-daily-report',
  standalone: true,
  imports: [
    PageTitleComponent,
    CommonModule,
...
export class DailyReportComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] = ["Date", "Affiliate_Name", "Revenue", "Adj_Revenue", "Leads", "Cost", "Profit", "Adj_Profit"]
