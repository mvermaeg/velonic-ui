...
import { DataTableItems, DataTableItemsType } from './conversionsdata'
import { TableService } from '@/app/tables/table.service'
@Component({
  selector: 'app-reports-affiliates-conversions',
  standalone: true,
  imports: [
    PageTitleComponent,
    CommonModule,
...
export class ConversionsComponent implements OnInit {
  selectedFields: (keyof DataTableItemsType)[] =["Date", "Campaign", "Affiliate_Name", "Revenue", "Conversions", "Clicks", "EPC", "CVR"]
